// Cruz de Vida — contenido del método (fuente: PDF "Cruz de vida, Baraja española")
window.CRUZ_DATA = {
  posiciones: [
    { key:'arriba',    nombre:'Pensamiento',          desc:'El pensamiento predominante relacionado con la pregunta.' },
    { key:'izquierda', nombre:'Camino',               desc:'Hacia dónde se dirige la situación; el camino que se abre.' },
    { key:'abajo',     nombre:'Realización',          desc:'Lo que ya se está manifestando en el presente.' },
    { key:'derecha',   nombre:'Lo que se deja atrás', desc:'Aquello que termina, se supera o queda en el pasado.' },
  ],
  categorias: [
    { key:'amor',   nombre:'Amor',             ids:[1,2,3,4] },
    { key:'dinero', nombre:'Dinero y trabajo', ids:[5,6,7,8,9,10,11,12] },
    { key:'salud',  nombre:'Salud y energía',  ids:[13,14] },
  ],
  preguntas: [
    { id:1, texto:'¿Mi expareja todavía piensa en mí?', cat:'amor',
      rep:{ tipo:'fija', palo:'copas', num:11, nombre:'Caballo de Copas' },
      resp:{
    ...
    { id:2, texto:'¿Qué energía tiene mi expareja hacia mí?', cat:'amor',
      rep:{ tipo:'fija', palo:'bastos', num:3, nombre:'Tres de Bastos', apodo:'Carta del Amor' },
      resp:{
    ...
    { id:3, texto:'¿Qué energía tiene mi pareja actual hacia mí?', cat:'amor',
      rep:{ tipo:'genero',
        mujer:{ palo:'copas', num:12, nombre:'Rey de Copas' },
        hombre:{ palo:'copas', num:10, nombre:'Diez de Copas' } },
      resp:{
    ...
    { id:4, texto:'¿Cómo está mi energía en el aspecto sentimental?', cat:'amor',
      rep:{ tipo:'multi',
        mujer:[ {palo:'espadas',num:12}, {palo:'oros',num:12}, {palo:'copas',num:12} ],
        hombre:[ {palo:'espadas',num:10}, {palo:'oros',num:10}, {palo:'copas',num:10} ] },
      grupos:{
        espadas:{ titulo:'Energía de una expareja', resp:{
        ...
        oros:{ titulo:'Energía de una relación informal', resp:{
        ...
        copas:{ titulo:'Energía de una relación estable', resp:{
    ...
    { id:5, texto:'¿Cómo está mi energía en el aspecto económico o del dinero?', cat:'dinero',
      rep:{ tipo:'fija', palo:'oros', num:7, nombre:'Siete de Oros' },
      resp:{
    ...
    { id:6, texto:'¿Va a mejorar mi situación económica?', cat:'dinero',
      rep:{ tipo:'fija', palo:'espadas', num:3, nombre:'Tres de Espadas', apodo:'Carta de la Solución' },
      resp:{
    ...
    { id:7, texto:'¿Vienen oportunidades o propuestas económicas para mí?', cat:'dinero',
      rep:{ tipo:'fija', palo:'bastos', num:2, nombre:'Dos de Bastos', apodo:'Carta de los Caminos y las Oportunidades' },
      resp:{
    ...
    { id:8, texto:'¿Se acercan nuevos ingresos?', cat:'dinero',
      rep:{ tipo:'fija', palo:'oros', num:7, nombre:'Siete de Oros', apodo:'Carta del Dinero' },
      resp:{
    ...
    { id:9, texto:'¿Es un buen momento para invertir o iniciar un proyecto?', cat:'dinero',
      rep:{ tipo:'fija', palo:'oros', num:1, nombre:'As de Oros', apodo:'Carta del Éxito y las Nuevas Oportunidades' },
      resp:{
    ...
    { id:10, texto:'¿Qué debo saber sobre mi economía en este momento?', cat:'dinero',
      rep:{ tipo:'fija', palo:'oros', num:3, nombre:'Tres de Oros', apodo:'Carta del Crecimiento Económico' },
      resp:{
    ...
    { id:11, texto:'¿Hay bloqueos que estén afectando mi prosperidad?', cat:'dinero',
      rep:{ tipo:'fija', palo:'espadas', num:2, nombre:'Dos de Espadas', apodo:'Carta de los Bloqueos' },
      resp:{
    ...
    { id:12, texto:'¿Vienen nuevas oportunidades de trabajo para mí?', cat:'dinero',
      rep:{ tipo:'fija', palo:'bastos', num:4, nombre:'Cuatro de Bastos', apodo:'Carta de las Oportunidades Laborales' },
      resp:{
    ...
    { id:13, texto:'¿Cómo está mi energía en cuestión de la salud?', cat:'salud',
      rep:{ tipo:'fija', palo:'espadas', num:5, nombre:'Cinco de Espadas', apodo:'Carta de la Salud' },
      resp:{
    ...
    { id:14, texto:'¿Cómo se encuentra mi energía física y emocional?', cat:'salud',
      rep:{ tipo:'fija', palo:'copas', num:3, nombre:'Tres de Copas', apodo:'Carta del Equilibrio Emocional' },
      resp:{
